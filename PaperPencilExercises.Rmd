...
#### Questions
a)
Show that $x = 0.5$ is the evolutionary stable sex ratio. To answer this question, you have to apply the two ESS conditions formulated by John Maynard Smith.

b)
Sketch the best response curve for this game (as we did for the Hawk-Dove game).

c)
Draw the PIP corresponding to this model. What conclusion can you derive from it?
