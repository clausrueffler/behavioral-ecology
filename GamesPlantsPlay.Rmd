...
### TASKS
  ...
  (1)
Evaluate all the above code. Understand what the results mean. Try to understand the code as much as possible (but note that code is not be relevant for the exam).
