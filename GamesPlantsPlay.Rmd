...
To obtain the second entry in each cell in the matrix by Kokko (which is the the payoff if the roles of who is mutant and how resident are switched) we only have to transpose the previous payoff matrix:
